...
export const en: Translations = {
  ...
  hero: {
    ...
    sub: "We handle the digital — site, CRM and an AI agent on WhatsApp. You just bring the brand — if you have one. If not, we'll create it for you. From ₪790/mo, zero setup.",
  ...
  agent: {
    ...
    sub: "Employee of the year. Books and cancels appointments. Answers every message with the best attitude, always. Doesn't take breaks and never sleeps.",
    ...
    plans: [
      {
        ...
        name: "Web + CRM",
        price: 790,
        tagline: "For businesses ready to compete in 2026.",
        items: [
          "Website, hosting & domain",
          "CRM with unlimited leads",
          "Online booking calendar",
          "2 AI agents 24/7 (web + WhatsApp)",
      ...
      },
      {
        ...
        name: "Web + CRM + Agent",
        price: 990,
        tagline: "For businesses that don't waste time or staff on bookings.",
        highlight: true,
        items: [
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Can the WhatsApp agent speak Arabic?",
        a: "Yes. The agent replies in whatever language the client writes in: Arabic, Hebrew, English, Russian or Spanish. No setup needed, it detects it automatically." },
    ],
  },
