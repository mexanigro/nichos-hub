...
export const en: Translations = {
  ...
  hero: {
    ...
    sub: "We handle the digital — site, CRM and an AI agent on WhatsApp. You just bring the brand — if you have one. If not, we'll create it for you. ₪770/mo, zero setup.",
    ...
    plans: [
      {
        ...
        name: "Web + CRM + Agent",
        price: 770,
        tagline: "Website, CRM, and AI WhatsApp agent — everything your business needs.",
        highlight: true,
        items: [
