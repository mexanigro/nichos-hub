...
export const en: Translations = {
  ...
  wizard: {
    ...
    errContact: "Please provide at least one contact method.", errEmail: "Please enter a valid email address.",
    noClientId: "Missing client ID", noClientIdSub: "Please use the link provided in your welcome email.",
    brandingTitle: "Do you have a visual brand?", brandingSub: "Your own logo, colors, and typography.",
    hasBrandingYes: "Yes, I have branding", hasBrandingNo: "Not yet",
    hasBrandingDesc: "I have a defined logo, colors and typography",
    hasBrandingNoDesc: "I don't have a visual identity yet",
    logoBlackWhiteLabel: "Logo in black & white",
    logoAllNote: "We need the logo in different versions: light background, dark background, and black & white. The more versions, the better.",
    wantsLiamTitle: "Would you like us to create it for you?", wantsLiamYes: "Yes, create it for me", wantsLiamNo: "I'll get it myself",
    wantsLiamDesc: "We'll create your logo and colors specially designed for your business, based on everything you're telling us",
    wantsLiamNoDesc: "Send us the branding once you have it",
    nicheCtx: "Your industry determines the default design, colors, and suggested services for your website.",
    modeCtx: "If you work solo, you are the brand. If you have a team, the business takes center stage.",
    contactCtx: "This info appears on your website so clients can message you, book, and find you.",
    servicesCtx: "Your services appear in a dedicated section with price and duration. Clients use it to book.",
    hoursCtx: "Business hours appear in the contact section so clients know when they can visit or reach you.",
    ownerCtx: "Your photo and bio build trust. They appear in the 'About us' section of your website.",
    galleryCtx: "The hero image spans the full width of the screen at the top of your website. The gallery showcases your work and space.",
    heroUploadHint: "Wide photo of your space or work — displays at 100% screen width",
    galleryUploadHint: "Photos of your space, work or products (you can upload several)",
    confirmTitle: "All done!",
    confirmFreeMsg: "With no strings attached, I'll create the complete design inspired by and tailored to your business, including a full logo and branding. If you have any questions, want to add something, or just want to chat, don't hesitate to reach out via WhatsApp. Your website will be ready within 24 to 72 hours.",
    confirmPaidMsg: "I received all your information. I'll review it personally and start building your website. If you have any questions or something to add, message me on WhatsApp. Your site will be ready within 24 to 72 hours.",
    confirmWhatsapp: "Message me on WhatsApp",
  },
  auth: {
    login: "Log in",
    register: "Sign up",
