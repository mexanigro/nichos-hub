...
export const en: Translations = {
  ...
  hero: {
    ...
    h1c: ", day and night.",
    sub: "A professional website with a CRM and an AI that answers WhatsApp and the phone for you, 24/7 — replying in seconds, booking appointments day and night, so no client slips away. No logo or content yet? It's on us. From ₪480/mo, zero setup.",
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        name: "Pro",
        price: 960,
        tagline: "Everything in Base + an AI phone receptionist that answers your calls 24/7 with a personalized voice.",
        highlight: true,
        bookingLimit: "300 bookings/mo",
        items: [
          "Everything in Base, plus:",
          "AI phone receptionist (personalized voice)",
    ...
    stamp: "Recommended",
    redesignHighlight: "Full website redesign every 90 days — free",
    setupLabel: "Setup",
    setupValue: "₪0",
    cta: "Start now",
