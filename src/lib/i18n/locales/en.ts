...
export const en: Translations = {
  ...
  hero: {
    eyebrow: "Your always-on digital team",
    h1a: "Your business ",
    h1b: "answers every client",
    h1c: ", day and night.",
    sub: "A professional website with a CRM for customers and bookings, and email notifications so no client slips away. No logo or content yet? It's on us. One-time setup ₪1,500, then ₪250/mo. WhatsApp agent and AI — optional add-ons.",
 ...
 why: "60% of WhatsApp messages and 40% of phone calls to local businesses go unanswered after hours. Without an agent, those clients book somewhere else. With one, every message and every call gets answered in seconds — around the clock, every day.",
    reasons: [
  ...
  pricing: {
    ...
    titleEm: "One plan, everything included.",
    sub: "A one-time setup, then a fixed monthly subscription in shekels. Cancel any month. Your data goes with you.",
    monthlyAbbr: "/mo",
    plans: [
      {
        planId: "web_crm",
        tag: "the plan",
        name: "Website + CRM + Email",
        price: 250,
        tagline: "A professional site, a customer & booking CRM, and email notifications. WhatsApp and AI — optional add-ons on request.",
        highlight: true,
        items: [
          "Custom website, hosting and domain",
          "CRM for customers, leads and bookings",
          "Online booking calendar",
          "Email notifications to you and your customers",
    ...
    stamp: "All included",
    redesignHighlight: "Free site redesign every 90 days",
    setupLabel: "One-time setup",
    setupValue: "₪1,500",
    cta: "Talk and get started",
    ctaSecondary: "See live work",
    note: "Cardcom · local invoice · no lock-in · WhatsApp agent, AI assistant and voice calls: optional, quoted separately",
  },
  ...
  pago: {
    ...
    contractBody: "By accepting, you subscribe to Arzac Studio: one plan — website + CRM + email notifications. One-time setup ₪1,500 (in-person signups: an agreed amount between ₪1,000 and ₪1,500), then ₪250/mo, no minimum term, cancel with 30 days' notice. WhatsApp agent, AI assistant and voice calls are not included and are quoted separately. Payment via Cardcom; we never store card details. The full agreement (v8.0) is below.",
  ...
  wizard: {
    ...
    niches: { barberia: "Barbershop", estetica: "Aesthetics", tattoo: "Tattoo", nails: "Nails", cafeteria: "Cafe", remodelaciones: "Renovations", peluqueria: "Hair salon", employment: "Employment", otro: "Other" },
