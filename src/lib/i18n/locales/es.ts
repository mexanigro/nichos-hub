...
export const es: Translations = {
  ...
  hero: {
    ...
    sub: "Un sitio web profesional con CRM de clientes y turnos, y notificaciones por email para que no se te escape ningún cliente. ¿No tenés logo ni contenido? Va por nuestra cuenta. Alta única ₪1.500 y después ₪250/mes. Agente de WhatsApp e IA — agregados opcionales.",
  ...
  agent: {
    ...
    reasons: [
      ...
      { t: "Habla árabe",       d: "Y hebreo, inglés, ruso, español. Contesta en el idioma en el que le hablan." },
      { t: "Atiende llamadas",  d: "Contesta el teléfono, agenda turnos y responde consultas con voz natural. Como tu mejor empleado." },
    ],
    chat: [
  ...
  everything: {
    ...
    items: [
      ...
      { t: "Soporte",         d: "Por WhatsApp siempre nos podés hablar. Sin tickets." },
    ],
  ...
  manifesto: {
    ...
    h: "El branding es un regalo. ",
    hEm: "La web, nuestra especialidad.",
    body: "¿No tenés logo, colores ni fotos? No te preocupes. Cuando te suscribís, el branding es nuestro regalo. Necesitamos la info de tu negocio para arrancar, pero si no tenés nada armado, lo hacemos por vos. Lo único que necesitamos es que nos cuentes qué hacés y a quién le vendés.",
    points: [
      { k: "Branding",          v: "Si ya tenés, lo usamos. Si no, te lo regalamos." },
      { k: "Contenido",         v: "Tuyo. Si no tenés nada, lo escribimos nosotros." },
      { k: "Info del negocio",  v: "Contanos qué hacés. Con eso alcanza." },
      { k: "Entrega",           v: "De 24 a 72 horas, listo y online." },
    ],
  },

  process: {
    eyebrow: "Proceso",
    title: "Desde que nos contactás al sitio online, máximo en ",
    titleEm: "72 horas.",
    steps: [
      { t: "Contacto", d: "15 min por WhatsApp o mensaje. Mapeamos servicios, horarios, marca, qué te hace distinto.",  time: "Hora 0" },
  ...
  pricing: {
    eyebrow: "Precios",
    title: "¿Cuánto cuesta una web para tu negocio? ",
    titleEm: "Un plan, todo incluido.",
    sub: "Un alta única y después una suscripción mensual fija en shekels. Cancelás cualquier mes. Los datos se van con vos.",
    monthlyAbbr: "/mes",
    plans: [
      {
        planId: "web_crm",
        ...
        name: "Web + CRM + Email",
        price: 250,
        tagline: "Sitio profesional, CRM de clientes y turnos, y notificaciones por email. WhatsApp e IA — agregados opcionales a pedido.",
        highlight: true,
        items: [
          "Web a medida, hosting y dominio",
          "CRM de clientes, leads y turnos",
          "Reservas online",
          "Notificaciones por email para vos y tus clientes",
          "Hebreo, inglés, ruso, español, árabe",
          "Mantenimiento y soporte continuo",
        ],
      },
    ],
    stamp: "Todo incluido",
    redesignHighlight: "Rediseño gratis de la web cada 90 días",
    setupLabel: "Alta única",
    setupValue: "₪1.500",
    cta: "Hablamos y arrancamos",
    ctaSecondary: "Ver webs en vivo",
    note: "Cardcom · factura local · sin ataduras · agente WhatsApp, asistente IA y llamadas de voz: opcionales, a cotizar aparte",
  },
  ...
  faq: {
    ...
    items: [
      { q: "¿Tengo que tener conocimientos técnicos?",
        a: "Para nada. No tocás código, hosting ni configuración — nunca. De eso nos ocupamos nosotros. Lo más técnico que te vamos a pedir es que elijas colores y nos pases tus fotos. Si no tenés ninguna de las dos, no te preocupes, ese es nuestro primer regalo." },
      { q: "¿Cómo sé si son confiables?",
        a: "Soy Liam Arzac — mis credenciales son públicas, el negocio está registrado. Cuando hables por WhatsApp podés pedir hablar conmigo, y si querés podemos hacer videollamada o vernos presencialmente si es posible. Tu seguridad es lo más importante para mí. Tampoco tengo acceso a tus datos sensibles al pagar — todo pasa por Cardcom, y si no los conocés, acá te dejo su link oficial israelí." },
      ...
      { q: "¿Quién entrena al agente de WhatsApp y de voz?",
        a: "Nosotros, con tus servicios, precios y tu tono. Entrenamos tanto al agente de WhatsApp como al de llamadas de voz. Lo afinamos mensualmente cuando cambiás precios o agregás staff. Siempre te avisamos cuando te pasa una conversación delicada." },
      ...
      { q: "¿Cuánto tarda en estar lista la web?",
        a: "Entre 24 y 72 horas desde que nos mandás tu info. Si tenés todo listo (logo, fotos, servicios), puede ser el mismo día. Si necesitás que armemos el branding, sumamos un par de horas." },
  ...
  pago: {
    ...
    contractBody: "Al aceptar, te suscribís a Arzac Studio: un plan — web + CRM + notificaciones por email. Alta única ₪1.500 (altas en persona: monto acordado entre ₪1.000 y ₪1.500) y después ₪250/mes, sin permanencia, cancelás con 30 días de aviso. Agente de WhatsApp, asistente IA y llamadas de voz no están incluidos y se cotizan aparte. Pago via Cardcom; nunca guardamos los datos de tu tarjeta. El acuerdo completo (v8.0) está abajo.",
  ...
  wizard: {
    ...
    niches: { barberia: "Barbería", estetica: "Estética", tattoo: "Tattoo", nails: "Uñas", cafeteria: "Cafetería", remodelaciones: "Remodelaciones", peluqueria: "Peluquería", employment: "Empleo", otro: "Otro" },
    ...
    demoEmailPh: "hola@minegocio.com",
    ...
    benefitsEmptyHint: "Tu sitio puede mostrar 3 a 5 razones para confiar. Si lo dejás vacío, uso un set genérico del rubro y vos lo afinás después.",
    benefitTitlePh: "Ej: 15 años de experiencia",
    benefitDescPh: "Una línea explicando por qué importa.",
    ...
    testimonialsEmptyHint: "Si tenés reviews en Google o IG, copialas acá. Si no, podés saltar este paso y me las pasás por WhatsApp después.",
    testimonialNamePh: "Ej: María R.",
    testimonialRolePh: "Cliente desde 2022",
    testimonialTextPh: "El mejor corte que tuve. Atención impecable.",
    ...
    faqEmptyHint: "Pensá en las 3-5 que te hacen siempre por WhatsApp antes de reservar. Si lo dejás vacío, armo un set genérico y vos lo afinás.",
    faqQuestionPh: "Ej: ¿Hace falta sacar turno antes?",
    faqAnswerPh: "Recomendado, pero también atendemos walk-in si hay disponibilidad.",
    listRemove: "Eliminar",
