...
export const es: Translations = {
  ...
  hero: {
    ...
    sub: "Nos encargamos de lo digital — web, CRM y agente IA en WhatsApp. Vos solo ponés el branding — si es que lo tenés. Si no, te lo regalamos. Desde ₪790/mes, cero setup.",
  ...
  agent: {
    ...
    sub: "El empleado del año. Reserva y cancela turnos. Contesta todos los mensajes con la mejor onda siempre. No va al baño y no duerme.",
    ...
    plans: [
      {
        ...
        name: "Web + CRM",
        price: 790,
        tagline: "Para negocios que quieren competir en serio en 2026.",
        items: [
          "Web, hosting y dominio",
          "CRM con leads ilimitados",
          "Calendario de turnos online",
          "2 agentes IA 24/7 (web + WhatsApp)",
      ...
      },
      {
        ...
        name: "Web + CRM + Agente",
        price: 990,
        tagline: "Para negocios que no pierden tiempo ni personal en tomar turnos.",
        highlight: true,
        items: [
  ...
  faq: {
    ...
    items: [
      ...
      { q: "¿El agente de WhatsApp puede hablar en árabe?",
        a: "Sí. El agente responde en el idioma en el que le escriben: árabe, hebreo, inglés, ruso o español. No hace falta configurar nada, lo detecta solo." },
    ],
  },
