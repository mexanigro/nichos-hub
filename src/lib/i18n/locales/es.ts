...
export const es: Translations = {
  ...
  wizard: {
    ...
    errContact: "Proporcioná al menos un método de contacto.", errEmail: "Ingresá un email válido.",
    noClientId: "Falta el ID de cliente", noClientIdSub: "Usá el enlace que recibiste en tu email de bienvenida.",
    brandingTitle: "¿Tenés marca visual?", brandingSub: "Logo, colores y tipografía propios.",
    hasBrandingYes: "Sí, tengo branding", hasBrandingNo: "Todavía no tengo",
    hasBrandingDesc: "Tengo logo, colores y tipografía definidos",
    hasBrandingNoDesc: "No tengo identidad visual todavía",
    logoBlackWhiteLabel: "Logo en blanco y negro",
    logoAllNote: "Necesitamos el logo en distintas versiones: fondo claro, fondo oscuro y blanco y negro. Cuantas más versiones, mejor.",
    wantsLiamTitle: "¿Querés que te lo creemos?", wantsLiamYes: "Sí, créenmelo", wantsLiamNo: "Lo consigo yo",
    wantsLiamDesc: "Te creamos el logo y los colores pensados especialmente para tu negocio, basándonos en todo lo que nos estás contando",
    wantsLiamNoDesc: "Nos mandás el branding una vez que lo tengas",
    nicheCtx: "El rubro determina el diseño, los colores predeterminados y los servicios sugeridos de tu web.",
    modeCtx: "Si trabajás solo, tu cara es la marca. Si tenés equipo, el negocio toma protagonismo.",
    contactCtx: "Estos datos aparecen en tu web para que los clientes puedan escribirte, reservar y encontrarte.",
    servicesCtx: "Tus servicios aparecen en una sección dedicada con precio y duración. Los clientes los usan para reservar.",
    hoursCtx: "Los horarios aparecen en la sección de contacto para que los clientes sepan cuándo pueden visitarte.",
    ownerCtx: "Tu foto y bio generan confianza. Aparecen en la sección 'Sobre nosotros' de tu web.",
    galleryCtx: "La imagen principal ocupa el ancho completo de la pantalla al inicio de tu web. La galería muestra tu trabajo y espacio.",
    heroUploadHint: "Foto amplia de tu local o trabajo — se ve al 100% del ancho de la pantalla",
    galleryUploadHint: "Fotos de tu espacio, trabajo o productos (podés subir varias)",
    confirmTitle: "¡Todo listo!",
    confirmFreeMsg: "Sin ningún compromiso te creo el diseño completo inspirado y pensado en tu negocio, con la creación completa del logo y el branding. Si tenés alguna duda, pregunta o algo para agregar, no dudes en comunicarte conmigo por WhatsApp. Entre las 24 y 72hs siguientes, tu web ya va a estar lista.",
    confirmPaidMsg: "Recibí toda tu información. Voy a revisarla personalmente y voy a empezar a crear tu web. Si tenés alguna duda o algo para agregar, escribime por WhatsApp. Entre las 24 y 72hs siguientes, tu web ya va a estar lista.",
    confirmWhatsapp: "Escribirme por WhatsApp",
  },
  auth: {
