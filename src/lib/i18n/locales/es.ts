...
export const es: Translations = {
    ...
    plans: [
      {
        ...
        name: "Solo Web",
        price: 480,
        tagline: "Web completa con chatbot, notificaciones por email. Sin WhatsApp, sin CRM.",
        items: [
          "Web, hosting y dominio",
          "Chatbot IA en la web",
          "Notificaciones Gmail al dueño",
          "Notificaciones Gmail a clientes",
      ...
      },
      {
        ...
        name: "Base",
        price: 770,
        tagline: "Web + CRM + WhatsApp chat. Ideal para negocios con hasta 100 reservas al mes.",
        bookingLimit: "100 bookings/mes",
        items: [
          "Web, hosting y dominio",
          "CRM con leads ilimitados",
          "Calendario de turnos online",
          "Agente IA en WhatsApp 24/7",
          "Hasta 100 bookings/mes incluidos",
          "Hebreo, inglés, ruso, español, árabe",
          "Soporte y tune-up mensual",
        ],
      },
      {
        planId: "pro",
        ...
        name: "Pro",
        price: 960,
        tagline: "Todo lo de Base + una recepcionista AI telefónica que atiende tus llamadas 24/7 con voz personalizada.",
        highlight: true,
        bookingLimit: "300 bookings/mes",
        items: [
          "Todo lo de Base, más:",
          "Recepcionista AI telefónica (voz personalizada)",
          "Hasta 300 bookings/mes incluidos",
      ...
      },
      {
        ...
        name: "Enterprise",
        price: 1270,
        tagline: "Todo ilimitado. Bookings y llamadas de voz sin tope.",
        bookingLimit: "Bookings ilimitados",
        items: [
          "Todo lo de Pro, más:",
          "Bookings ilimitados",
          "Llamadas de voz ilimitadas",
          "Tune-up semanal del agente",
          "Soporte dedicado",
        ],
      },
    ],
  ...
  pago: {
    ...
    contractBody: "Al aceptar, te suscribís a Arzac Studio. Planes: Solo Web (₪480/mes — web, chatbot IA, notificaciones por email), Base (₪770/mes — web, CRM, agente WhatsApp IA, 100 reservas/mes), Pro (₪960/mes — todo lo de Base + llamadas de voz IA, 300 reservas/mes), Enterprise (₪1.270/mes — todo ilimitado + soporte prioritario). Si alcanzás el límite de reservas, se upgrade automáticamente al siguiente nivel desde el próximo ciclo. Pago mensual vía Cardcom. Cero setup. Cancelás cuando quieras — tu data, dominio e historial se van con vos. Términos completos en arzac.studio/terms.",
