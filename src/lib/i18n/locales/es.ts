...
export const es: Translations = {
  ...
  hero: {
    ...
    sub: "Nos encargamos de lo digital — web, CRM y agente IA en WhatsApp. Vos solo ponés el branding — si es que lo tenés. Si no, te lo regalamos. ₪770/mes, cero setup.",
    ...
    plans: [
      {
        ...
        name: "Web + CRM + Agente",
        price: 770,
        tagline: "Web, CRM y agente IA en WhatsApp — todo lo que tu negocio necesita.",
        highlight: true,
        items: [
          ...
          "Soporte prioritario y tune-up mensual",
        ],
      },
    ],
    stamp: "",
