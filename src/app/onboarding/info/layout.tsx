...
export const metadata: Metadata = {
  title: "Complete Your Setup — Arzac Studio",
  description: "Submit your business information to complete your website setup.",
  robots: { index: false, follow: false },
};

export default function OnboardingInfoLayout({ children }: { children: React.ReactNode }) {
  return (
    <LandingI18nProvider>
