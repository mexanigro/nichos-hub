...
export function Founder() {
  ...
  return (
    <section className="at-founder" id="founder" ref={reveal} data-reveal>
      <div className="container">
        <div className="at-founder-wrap">
          <div className="at-founder-portrait">
            <span className="badge">{t.founder.badge}</span>
          ...
          <div className="at-founder-copy">
            ...
            <a className="at-founder-cta" href={WA_HREF} target="_blank" rel="noopener noreferrer">
              {WA_ICON}
              {t.founder.cta}
            </a>
          </div>
