...
export function WizardConfirmation({ variant }: WizardConfirmationProps) {
  const { t, isRTL } = useT();
  const w = t.wizard;
      ...
      <main className="wiz-body">
        <div className="wiz-content">
          <div className="wiz-confirm">
            ...
            <h1 className="wiz-confirm-title">{w.confirmTitle}</h1>
            <p className="wiz-confirm-msg">
              {variant === "free" ? w.confirmFreeMsg : w.confirmPaidMsg}
            </p>
            <a
              href={`https://wa.me/${waNumber}`}
              target="_blank"
              rel="noopener noreferrer"
              className="wiz-btn-primary wiz-confirm-wa"
            >
