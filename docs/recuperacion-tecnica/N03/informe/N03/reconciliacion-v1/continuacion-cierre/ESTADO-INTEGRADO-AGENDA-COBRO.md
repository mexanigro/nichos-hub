...
- Orden único de cierre: agenda/autorización → cobro → revisión integrada del BALANCE y acta. Techo100% TOTAL, últimos2puntos reservados; última observación94% al registrar este corte. Sin resets, instalaciones, efectos externos,push/deploy,ramas/worktrees.
