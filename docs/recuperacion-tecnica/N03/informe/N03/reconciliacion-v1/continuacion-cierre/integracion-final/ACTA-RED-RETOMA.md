...
| Rechazar recorrido válido | RED52 nuevos; los16delprecio no se alcanzan por el corte temprano. Población232checks. No se restan16: detecta bloqueo de casos válidos, no sólo ausencia de excepciones. resultados/mutante-reject-final. |
