...
Las decisiones N01 y el balance no establecen que Admin y REST puedan apuntar a proyectos distintos para este subconjunto, ni fijan una prioridad común. Por eso no corresponde declarar un defecto universal ni imponer unificación. **Recomiendo aprobar esta regla acotada: estos dos accesores Admin y los helpers REST general deben operar sobre un mismo proyecto/base; si la configuración o una aplicación existente no son compatibles, rechazar antes de operar, sin escoger silenciosamente otro proyecto ni recrear aplicaciones.**
