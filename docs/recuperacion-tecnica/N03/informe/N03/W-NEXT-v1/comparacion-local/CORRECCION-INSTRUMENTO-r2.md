...
Se conservaron scripts r1 en preimagenes-instrumento-r1 y resultados/middleware íntegros. Única corrección del instrumento: ajustar esas expectativas, mantener la población idéntica de129 casos y las demás expectativas intactas; reutilizar build sin modificar fuente y repetir HTTP en middleware-r2. Resultado129/129,exit0. No se cambia aceptación para cubrir implementación incorrecta: no hay implementación de producto, ni se cambia qué accesos/rechazos deben preservarse.
