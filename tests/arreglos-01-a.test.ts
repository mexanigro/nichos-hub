...
// Recorte: entera; sube a un bucket en memoria, no a Storage.
...
import { B4_MATERIAL, CONFIG_TAB, MEDIA_UPLOAD, ROOT, RUTA_LOGO, VIEJO_LOGO, canonico, fuente, importarModulo } from "./orden/arreglos-01/_comun.ts";
