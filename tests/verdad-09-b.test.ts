...
import { REPO, aprobadasMinima, conTemporal, copiarTools, hojaMinima, leer, paridad, repoConOrdenViva, repoTemporal, rojoVerdeTodas, ultimaLinea } from "./orden/verdad-09/_comun.ts";
