...
// original, conexion-08 era la viva y estaba escrita a mano; ya está retirada).
import { test } from "node:test";
import assert from "node:assert/strict";
import { existsSync, readFileSync } from "node:fs";
import { matchesGlob, resolve } from "node:path";
import { CONEXION_07, REPO, ROOT, conTemporal, cuentaTests, cuentaTestsDe, excluidas, git, ordenesVivas, reproducirHead, rojoVerdeTodas } from "./orden/conexion-08/_comun.ts";
