...
import { ROOT, SOY, bloqueContrato, git, seccionPuertas } from "./orden/verdad-05/_util.ts";

/** Commit aprobado de VERDAD-04 en este repo (Liam, 2026-09-21): el bloque CONTRATO-DECLARADO no debe moverse de ahí. */
// VERDAD-06 B1 (2026-09-21): hook.PreToolUse pasa a Edit|Write|MultiEdit|Bash|PowerShell; la copia compara el bloque sin esa línea (verdad-06 e la vigila).
