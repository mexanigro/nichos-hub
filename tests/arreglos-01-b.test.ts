...
// Recorte: entera; resuelve sobre una colección en memoria, no sobre Firestore.
...
import { HUB_CLIENTS, PAGINA_FICHA, ROOT, RUTA_FICHA, canonico, fuente, importarModulo } from "./orden/arreglos-01/_comun.ts";
