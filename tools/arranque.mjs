...
// VERDAD-07 (2026-09-21, B2): por cada raíz donde exista .git/permitir-tests (el permiso de la sesión A, D-30) imprime
// «PERMISO ABIERTO · <repo>: .git/permitir-tests existe (sólo la sesión A)»; nada si no existe.
// Nunca falla: si algo no se puede leer, lo dice y sigue (exit 0 siempre, o no entra al contexto).
import { existsSync, readFileSync } from "node:fs";
import { BLOQUE_DIR, ROOT, ROJO, estados, filaAbierta, git, permisosAbiertos, ultimasDecisiones } from "./_git.mjs";
